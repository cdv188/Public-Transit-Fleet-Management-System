...
/**
 * Command that runs automated system health checks using observer-based monitors.
 */
public class RunSystemChecksCommand implements Command {

    /**
     * Executes system health checks for component wear and fuel consumption.
     * Results are displayed in an HTML response, and alerts are logged if issues are found.
     *
